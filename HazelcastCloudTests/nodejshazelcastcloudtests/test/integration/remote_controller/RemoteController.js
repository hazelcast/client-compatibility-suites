...
var RemoteController_createHazelcastCloudEnterpriseCluster_args = function(args) {
  this.cloudProvider = null;
  this.hazelcastVersion = null;
  this.isTlsEnabled = null;
  if (args) {
    if (args.cloudProvider !== undefined && args.cloudProvider !== null) {
...
RemoteController_createHazelcastCloudEnterpriseCluster_args.prototype = {};
RemoteController_createHazelcastCloudEnterpriseCluster_args.prototype.read = function(input) {
  input.readStructBegin();
  while (true) {
    var ret = input.readFieldBegin();
    var ftype = ret.ftype;
    ...
    switch (fid) {
      case 1:
      if (ftype == Thrift.Type.STRING) {
        this.cloudProvider = input.readString();
      } else {
        input.skip(ftype);
      }
      break;
...
RemoteController_createHazelcastCloudEnterpriseCluster_args.prototype.write = function(output) {
  output.writeStructBegin('RemoteController_createHazelcastCloudEnterpriseCluster_args');
  if (this.cloudProvider !== null && this.cloudProvider !== undefined) {
    output.writeFieldBegin('cloudProvider', Thrift.Type.STRING, 1);
    output.writeString(this.cloudProvider);
    output.writeFieldEnd();
  }
  if (this.hazelcastVersion !== null && this.hazelcastVersion !== undefined) {
    output.writeFieldBegin('hazelcastVersion', Thrift.Type.STRING, 2);
    output.writeString(this.hazelcastVersion);
    output.writeFieldEnd();
  }
  if (this.isTlsEnabled !== null && this.isTlsEnabled !== undefined) {
    output.writeFieldBegin('isTlsEnabled', Thrift.Type.BOOL, 3);
    output.writeBool(this.isTlsEnabled);
    output.writeFieldEnd();
  }
  output.writeFieldStop();
...
var RemoteController_createHazelcastCloudEnterpriseCluster_result = function(args) {
  this.success = null;
  if (args) {
    if (args.success !== undefined && args.success !== null) {
      this.success = new ttypes.CloudCluster(args.success);
...
RemoteController_createHazelcastCloudEnterpriseCluster_result.prototype = {};
RemoteController_createHazelcastCloudEnterpriseCluster_result.prototype.read = function(input) {
  input.readStructBegin();
  while (true) {
    var ret = input.readFieldBegin();
    var ftype = ret.ftype;
...
RemoteController_createHazelcastCloudEnterpriseCluster_result.prototype.write = function(output) {
  output.writeStructBegin('RemoteController_createHazelcastCloudEnterpriseCluster_result');
  if (this.success !== null && this.success !== undefined) {
    output.writeFieldBegin('success', Thrift.Type.STRUCT, 0);
    this.success.write(output);
    output.writeFieldEnd();
...
var RemoteController_scaleUpDownHazelcastCloudStandardCluster_args = function(args) {
  this.id = null;
  ...
  if (args) {
    ...
    if (args.scaleNumber !== undefined && args.scaleNumber !== null) {
      this.scaleNumber = args.scaleNumber;
    }
  }
};
RemoteController_scaleUpDownHazelcastCloudStandardCluster_args.prototype = {};
RemoteController_scaleUpDownHazelcastCloudStandardCluster_args.prototype.read = function(input) {
  input.readStructBegin();
  while (true) {
    var ret = input.readFieldBegin();
    var ftype = ret.ftype;
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.I32) {
        this.scaleNumber = input.readI32();
      } else {
        input.skip(ftype);
      }
      break;
...
RemoteController_scaleUpDownHazelcastCloudStandardCluster_args.prototype.write = function(output) {
  output.writeStructBegin('RemoteController_scaleUpDownHazelcastCloudStandardCluster_args');
  if (this.id !== null && this.id !== undefined) {
    output.writeFieldBegin('id', Thrift.Type.STRING, 1);
    output.writeString(this.id);
    output.writeFieldEnd();
  }
  if (this.scaleNumber !== null && this.scaleNumber !== undefined) {
    output.writeFieldBegin('scaleNumber', Thrift.Type.I32, 2);
    output.writeI32(this.scaleNumber);
    output.writeFieldEnd();
  }
  output.writeFieldStop();
  output.writeStructEnd();
...
var RemoteController_scaleUpDownHazelcastCloudStandardCluster_result = function(args) {
  this.success = null;
  if (args) {
    if (args.success !== undefined && args.success !== null) {
      this.success = args.success;
...
RemoteController_scaleUpDownHazelcastCloudStandardCluster_result.prototype = {};
RemoteController_scaleUpDownHazelcastCloudStandardCluster_result.prototype.read = function(input) {
  input.readStructBegin();
  while (true) {
    var ret = input.readFieldBegin();
    var ftype = ret.ftype;
...
RemoteController_scaleUpDownHazelcastCloudStandardCluster_result.prototype.write = function(output) {
  output.writeStructBegin('RemoteController_scaleUpDownHazelcastCloudStandardCluster_result');
  if (this.success !== null && this.success !== undefined) {
    output.writeFieldBegin('success', Thrift.Type.BOOL, 0);
    output.writeBool(this.success);
    output.writeFieldEnd();
...
RemoteControllerClient.prototype.loginToHazelcastCloud = function(uri, apiKey, apiSecret, callback) {
  this._seqid = this.new_seqid();
  if (callback === undefined) {
    var _defer = Q.defer();
    this._reqs[this.seqid()] = function(error, result) {
    ...
    this.send_loginToHazelcastCloud(uri, apiKey, apiSecret);
    return _defer.promise;
  } else {
    this._reqs[this.seqid()] = callback;
    this.send_loginToHazelcastCloud(uri, apiKey, apiSecret);
...
RemoteControllerClient.prototype.send_loginToHazelcastCloud = function(uri, apiKey, apiSecret) {
  var output = new this.pClass(this.output);
  var params = {
    uri: uri,
    apiKey: apiKey,
...
RemoteControllerClient.prototype.createHazelcastCloudEnterpriseCluster = function(cloudProvider, hazelcastVersion, isTlsEnabled, callback) {
  this._seqid = this.new_seqid();
  if (callback === undefined) {
    var _defer = Q.defer();
    this._reqs[this.seqid()] = function(error, result) {
    ...
    this.send_createHazelcastCloudEnterpriseCluster(cloudProvider, hazelcastVersion, isTlsEnabled);
    return _defer.promise;
  } else {
    this._reqs[this.seqid()] = callback;
    this.send_createHazelcastCloudEnterpriseCluster(cloudProvider, hazelcastVersion, isTlsEnabled);
...
RemoteControllerClient.prototype.send_createHazelcastCloudEnterpriseCluster = function(cloudProvider, hazelcastVersion, isTlsEnabled) {
  var output = new this.pClass(this.output);
  var params = {
  ...
  var args = new RemoteController_createHazelcastCloudEnterpriseCluster_args(params);
  try {
    output.writeMessageBegin('createHazelcastCloudEnterpriseCluster', Thrift.MessageType.CALL, this.seqid());
    args.write(output);
    output.writeMessageEnd();
    return this.output.flush();
  }
...
RemoteControllerClient.prototype.recv_createHazelcastCloudEnterpriseCluster = function(input,mtype,rseqid) {
  var callback = this._reqs[rseqid] || function() {};
  delete this._reqs[rseqid];
  if (mtype == Thrift.MessageType.EXCEPTION) {
    var x = new Thrift.TApplicationException();
  ...
  var result = new RemoteController_createHazelcastCloudEnterpriseCluster_result();
  result.read(input);
  input.readMessageEnd();
  ...
  return callback('createHazelcastCloudEnterpriseCluster failed: unknown result');
};

RemoteControllerClient.prototype.scaleUpDownHazelcastCloudStandardCluster = function(id, scaleNumber, callback) {
  this._seqid = this.new_seqid();
  if (callback === undefined) {
    var _defer = Q.defer();
    this._reqs[this.seqid()] = function(error, result) {
    ...
    this.send_scaleUpDownHazelcastCloudStandardCluster(id, scaleNumber);
    return _defer.promise;
  } else {
    this._reqs[this.seqid()] = callback;
    this.send_scaleUpDownHazelcastCloudStandardCluster(id, scaleNumber);
...
RemoteControllerClient.prototype.send_scaleUpDownHazelcastCloudStandardCluster = function(id, scaleNumber) {
  var output = new this.pClass(this.output);
  var params = {
    id: id,
    scaleNumber: scaleNumber
  };
  var args = new RemoteController_scaleUpDownHazelcastCloudStandardCluster_args(params);
  try {
    output.writeMessageBegin('scaleUpDownHazelcastCloudStandardCluster', Thrift.MessageType.CALL, this.seqid());
    args.write(output);
    output.writeMessageEnd();
    return this.output.flush();
  }
...
RemoteControllerClient.prototype.recv_scaleUpDownHazelcastCloudStandardCluster = function(input,mtype,rseqid) {
  var callback = this._reqs[rseqid] || function() {};
  delete this._reqs[rseqid];
  if (mtype == Thrift.MessageType.EXCEPTION) {
    var x = new Thrift.TApplicationException();
  ...
  var result = new RemoteController_scaleUpDownHazelcastCloudStandardCluster_result();
  result.read(input);
  input.readMessageEnd();
  ...
  return callback('scaleUpDownHazelcastCloudStandardCluster failed: unknown result');
};

RemoteControllerClient.prototype.getHazelcastCloudCluster = function(id, callback) {
  this._seqid = this.new_seqid();
  if (callback === undefined) {
    var _defer = Q.defer();
    this._reqs[this.seqid()] = function(error, result) {
    ...
    this.send_getHazelcastCloudCluster(id);
    return _defer.promise;
  } else {
    this._reqs[this.seqid()] = callback;
    this.send_getHazelcastCloudCluster(id);
...
RemoteControllerClient.prototype.send_getHazelcastCloudCluster = function(id) {
  var output = new this.pClass(this.output);
  var params = {
    id: id
  };
...
RemoteControllerClient.prototype.stopHazelcastCloudCluster = function(id, callback) {
  this._seqid = this.new_seqid();
  if (callback === undefined) {
    var _defer = Q.defer();
    this._reqs[this.seqid()] = function(error, result) {
    ...
    this.send_stopHazelcastCloudCluster(id);
    return _defer.promise;
  } else {
    this._reqs[this.seqid()] = callback;
    this.send_stopHazelcastCloudCluster(id);
...
RemoteControllerClient.prototype.send_stopHazelcastCloudCluster = function(id) {
  var output = new this.pClass(this.output);
  var params = {
    id: id
  };
...
RemoteControllerClient.prototype.resumeHazelcastCloudCluster = function(id, callback) {
  this._seqid = this.new_seqid();
  if (callback === undefined) {
    var _defer = Q.defer();
    this._reqs[this.seqid()] = function(error, result) {
    ...
    this.send_resumeHazelcastCloudCluster(id);
    return _defer.promise;
  } else {
    this._reqs[this.seqid()] = callback;
    this.send_resumeHazelcastCloudCluster(id);
...
RemoteControllerClient.prototype.send_resumeHazelcastCloudCluster = function(id) {
  var output = new this.pClass(this.output);
  var params = {
    id: id
  };
...
RemoteControllerClient.prototype.deleteHazelcastCloudCluster = function(id, callback) {
  this._seqid = this.new_seqid();
  if (callback === undefined) {
    var _defer = Q.defer();
    this._reqs[this.seqid()] = function(error, result) {
    ...
    this.send_deleteHazelcastCloudCluster(id);
    return _defer.promise;
  } else {
    this._reqs[this.seqid()] = callback;
    this.send_deleteHazelcastCloudCluster(id);
...
RemoteControllerClient.prototype.send_deleteHazelcastCloudCluster = function(id) {
  var output = new this.pClass(this.output);
  var params = {
    id: id
  };
...
RemoteControllerClient.prototype.recv_deleteHazelcastCloudCluster = function(input,mtype,rseqid) {
  ...
  return callback('deleteHazelcastCloudCluster failed: unknown result');
};
...
RemoteControllerProcessor.prototype.process_loginToHazelcastCloud = function(seqid, input, output) {
  ...
  if (this._handler.loginToHazelcastCloud.length === 3) {
    ...
    this._handler.loginToHazelcastCloud(args.uri, args.apiKey, args.apiSecret, function (err, result) {
      var result_obj;
      if ((err === null || typeof err === 'undefined')) {
...
RemoteControllerProcessor.prototype.process_createHazelcastCloudEnterpriseCluster = function(seqid, input, output) {
  var args = new RemoteController_createHazelcastCloudEnterpriseCluster_args();
  args.read(input);
  input.readMessageEnd();
  if (this._handler.createHazelcastCloudEnterpriseCluster.length === 3) {
    Q.fcall(this._handler.createHazelcastCloudEnterpriseCluster.bind(this._handler),
      args.cloudProvider,
      args.hazelcastVersion,
      args.isTlsEnabled
    ).then(function(result) {
      var result_obj = new RemoteController_createHazelcastCloudEnterpriseCluster_result({success: result});
      output.writeMessageBegin("createHazelcastCloudEnterpriseCluster", Thrift.MessageType.REPLY, seqid);
      result_obj.write(output);
      output.writeMessageEnd();
      output.flush();
    }).catch(function (err) {
      var result;
      result = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
      output.writeMessageBegin("createHazelcastCloudEnterpriseCluster", Thrift.MessageType.EXCEPTION, seqid);
      result.write(output);
      output.writeMessageEnd();
      output.flush();
    });
  } else {
    this._handler.createHazelcastCloudEnterpriseCluster(args.cloudProvider, args.hazelcastVersion, args.isTlsEnabled, function (err, result) {
      var result_obj;
      if ((err === null || typeof err === 'undefined')) {
        result_obj = new RemoteController_createHazelcastCloudEnterpriseCluster_result((err !== null || typeof err === 'undefined') ? err : {success: result});
        output.writeMessageBegin("createHazelcastCloudEnterpriseCluster", Thrift.MessageType.REPLY, seqid);
      } else {
        result_obj = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
        output.writeMessageBegin("createHazelcastCloudEnterpriseCluster", Thrift.MessageType.EXCEPTION, seqid);
...
RemoteControllerProcessor.prototype.process_scaleUpDownHazelcastCloudStandardCluster = function(seqid, input, output) {
  var args = new RemoteController_scaleUpDownHazelcastCloudStandardCluster_args();
  args.read(input);
  input.readMessageEnd();
  if (this._handler.scaleUpDownHazelcastCloudStandardCluster.length === 2) {
    Q.fcall(this._handler.scaleUpDownHazelcastCloudStandardCluster.bind(this._handler),
      args.id,
      args.scaleNumber
    ).then(function(result) {
      var result_obj = new RemoteController_scaleUpDownHazelcastCloudStandardCluster_result({success: result});
      output.writeMessageBegin("scaleUpDownHazelcastCloudStandardCluster", Thrift.MessageType.REPLY, seqid);
      result_obj.write(output);
      output.writeMessageEnd();
      output.flush();
    }).catch(function (err) {
      var result;
      result = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
      output.writeMessageBegin("scaleUpDownHazelcastCloudStandardCluster", Thrift.MessageType.EXCEPTION, seqid);
      result.write(output);
      output.writeMessageEnd();
      output.flush();
    });
  } else {
    this._handler.scaleUpDownHazelcastCloudStandardCluster(args.id, args.scaleNumber, function (err, result) {
      var result_obj;
      if ((err === null || typeof err === 'undefined')) {
        result_obj = new RemoteController_scaleUpDownHazelcastCloudStandardCluster_result((err !== null || typeof err === 'undefined') ? err : {success: result});
        output.writeMessageBegin("scaleUpDownHazelcastCloudStandardCluster", Thrift.MessageType.REPLY, seqid);
      } else {
        result_obj = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
        output.writeMessageBegin("scaleUpDownHazelcastCloudStandardCluster", Thrift.MessageType.EXCEPTION, seqid);
...
RemoteControllerProcessor.prototype.process_getHazelcastCloudCluster = function(seqid, input, output) {
  ...
  if (this._handler.getHazelcastCloudCluster.length === 1) {
    ...
    this._handler.getHazelcastCloudCluster(args.id, function (err, result) {
      var result_obj;
      if ((err === null || typeof err === 'undefined')) {
...
RemoteControllerProcessor.prototype.process_stopHazelcastCloudCluster = function(seqid, input, output) {
  ...
  if (this._handler.stopHazelcastCloudCluster.length === 1) {
    ...
    this._handler.stopHazelcastCloudCluster(args.id, function (err, result) {
      var result_obj;
      if ((err === null || typeof err === 'undefined')) {
...
RemoteControllerProcessor.prototype.process_resumeHazelcastCloudCluster = function(seqid, input, output) {
  ...
  if (this._handler.resumeHazelcastCloudCluster.length === 1) {
    ...
    this._handler.resumeHazelcastCloudCluster(args.id, function (err, result) {
      var result_obj;
      if ((err === null || typeof err === 'undefined')) {
...
RemoteControllerProcessor.prototype.process_deleteHazelcastCloudCluster = function(seqid, input, output) {
  ...
  if (this._handler.deleteHazelcastCloudCluster.length === 1) {
    ...
    this._handler.deleteHazelcastCloudCluster(args.id, function (err, result) {
      var result_obj;
      if ((err === null || typeof err === 'undefined')) {
