...
namespace Hazelcast.Testing.Remote
{
  ...
  public partial class CloudCluster : TBase
  {
    ...
    private string _nameForConnect;
    ...
    public string NameForConnect
    {
      get
      {
        return _nameForConnect;
      }
      set
      {
        __isset.nameForConnect = true;
        this._nameForConnect = value;
      }
    }
    ...
    public CloudCluster DeepCopy()
    {
      ...
      if((NameForConnect != null) && __isset.nameForConnect)
      {
        tmp5.NameForConnect = this.NameForConnect;
      }
      tmp5.__isset.nameForConnect = this.__isset.nameForConnect;
        ...
        while (true)
        {
          ...
          switch (field.ID)
          {
            ...
            case 3:
              if (field.Type == TType.String)
              {
                NameForConnect = await iprot.ReadStringAsync(cancellationToken);
              }
              else
              {
                await TProtocolUtil.SkipAsync(iprot, field.Type, cancellationToken);
    ...
    public async global::System.Threading.Tasks.Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
    {
      ...
      try
      {
        ...
        if((NameForConnect != null) && __isset.nameForConnect)
        {
          tmp7.Name = "nameForConnect";
          tmp7.Type = TType.String;
          tmp7.ID = 3;
          await oprot.WriteFieldBeginAsync(tmp7, cancellationToken);
          await oprot.WriteStringAsync(NameForConnect, cancellationToken);
          await oprot.WriteFieldEndAsync(cancellationToken);
        }
        if((HazelcastVersion != null) && __isset.hazelcastVersion)
        {
    ...
    public override bool Equals(object that)
    {
      ...
      return ((__isset.id == other.__isset.id) && ((!__isset.id) || (System.Object.Equals(Id, other.Id))))
        ...
        && ((__isset.nameForConnect == other.__isset.nameForConnect) && ((!__isset.nameForConnect) || (System.Object.Equals(NameForConnect, other.NameForConnect))))
    ...
    public override int GetHashCode() {
      ...
      unchecked {
        ...
        if((NameForConnect != null) && __isset.nameForConnect)
        {
          hashcode = (hashcode * 397) + NameForConnect.GetHashCode();
        }
        if((HazelcastVersion != null) && __isset.hazelcastVersion)
        {
    ...
    public override string ToString()
    {
      ...
      {
        if(0 < tmp9++) { tmp8.Append(", "); }
        tmp8.Append("NameForConnect: ");
        NameForConnect.ToString(tmp8);
      }
      if((HazelcastVersion != null) && __isset.hazelcastVersion)
      {
        if(0 < tmp9++) { tmp8.Append(", "); }
