...
export declare class BaseProxy {
     ...
     * @returns
     */
    protected encodeInvokeOnKeyWithTimeout<T>(timeoutMillis: number, codec: any, partitionKey: any, ...codecArguments: any[]): Promise<T>;
    /**
     ...
     * @returns
     */
    protected encodeInvokeOnPartitionWithTimeout<T>(timeoutMillis: number, codec: any, partitionId: number, ...codecArguments: any[]): Promise<T>;
    /**
