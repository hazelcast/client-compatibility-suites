...
var LockProxy = /** @class */ (function (_super) {
    ...
    LockProxy.prototype.lock = function (leaseMillis) {
        ...
        return this.encodeInvokeWithTimeout(Number.MAX_SAFE_INTEGER, LockLockCodec_1.LockLockCodec, leaseMillis, 1, this.nextSequence());
    };
    LockProxy.prototype.tryLock = function (timeoutMillis, leaseMillis) {
        if (timeoutMillis === void 0) { timeoutMillis = 0; }
        if (leaseMillis === void 0) { leaseMillis = -1; }
        return this.encodeInvokeWithTimeout(Number.MAX_SAFE_INTEGER, LockTryLockCodec_1.LockTryLockCodec, 1, leaseMillis, timeoutMillis, this.nextSequence());
    };
