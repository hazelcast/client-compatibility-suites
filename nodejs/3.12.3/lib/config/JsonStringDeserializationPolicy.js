...
(function (JsonStringDeserializationPolicy) {
     ...
     */
    JsonStringDeserializationPolicy[JsonStringDeserializationPolicy["EAGER"] = 0] = "EAGER";
    /**
     * Raw JSON strings are returned around a
     * lightweight {@link HazelcastJsonValue}
     * wrapper.
     */
    JsonStringDeserializationPolicy[JsonStringDeserializationPolicy["NO_DESERIALIZATION"] = 1] = "NO_DESERIALIZATION";
