...
export declare class ObjectDataOutput implements DataOutput {
    ...
    private writeUTFStandard(val);
    private writeUTFLegacy(val);
}
...
export declare class ObjectDataInput implements DataInput {
    ...
    private standardUTF;
    private pos;
    constructor(buffer: Buffer, offset: number, serializationService: SerializationService, isBigEndian: boolean, isStandardUTF: boolean);
    isBigEndian(): boolean;
    position(newPosition?: number): number;
    ...
    private readUTFLegacy(pos?);
    private readUTFStandard(pos?);
