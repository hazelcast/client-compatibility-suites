...
var ClientMessage = /** @class */ (function () {
    ...
    ClientMessage.prototype.clone = function () {
        var message = new ClientMessage(safe_buffer_1.Buffer.from(this.buffer));
    ...
    ClientMessage.prototype.appendString = function (value) {
        var length = safe_buffer_1.Buffer.byteLength(value, 'utf8');
    ...
    ClientMessage.prototype.readBuffer = function () {
        ...
        this.cursor += BitsUtil_1.BitsUtil.INT_SIZE_IN_BYTES;
        var result = this.buffer.slice(this.cursor, this.cursor + size);
        this.cursor += size;
        return result;
    };
